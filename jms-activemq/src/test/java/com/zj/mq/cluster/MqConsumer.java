...
public class MqConsumer {
	 ...
	 * 服务地址
	 */
	private final static String URL = "failover:(tcp://192.168.11.216:61616,tcp://192.168.11.224:61616,tcp://192.168.11.225:61616)?randomize=true";
	...
	public static void main(String[] args) throws Exception {
		...
		consumer.setMessageListener(new MessageListener() {
			...
			public void onMessage(Message message) {
				...
				try {
					System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())+"<-ActiveMq 接收到消息：" + textMessage.getText());
